export const categories = [
    ...
    components: [
      {
        ...
        title: "Form Layout 1",
        description: "Form with grouped fields, labels, and submit area.",
        isPro: true,
        registryName: "form-layout1"
      },
      {
        href: "/blocks/form-layouts/2",
        title: "Form Layout 2",
        description: "Form layout with columns or sections and actions.",
        isPro: true,
        registryName: "form-layout2"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    components: [
      ...
      {
        href: "/blocks/sign-in-forms/2",
        title: "Sign In Form 2",
        description: "Sign-in layout with fields and optional social or link.",
        isPro: true,
        registryName: "signin-form2"
      },
      {
        href: "/blocks/sign-in-forms/3",
        title: "Sign In Form 3",
        description: "Login form with card layout and primary CTA.",
        isPro: true,
        registryName: "signin-form3"
      }
    ]
  },
  {
    ...
    components: [
      {
        ...
        description: "Modal with title, content area, and action buttons.",
        isPro: true,
        registryName: "dashboard-modal1",
        height: 500
      },
      {
        href: "/blocks/modal-dialogs/2",
        title: "Modal Dialog 2",
        description: "Dialog layout with header, body, and footer actions.",
        isPro: true,
        registryName: "dashboard-modal2"
      },
      {
        href: "/blocks/modal-dialogs/3",
        title: "Modal Dialog 3",
        description: "Modal or dialog with form or confirmation content.",
        isPro: true,
        registryName: "dashboard-modal3",
        height: 600
      }
    ]
  },
    ...
    components: [
      {
        ...
        title: "Page Layout 1",
        description: "Dashboard page with header and main content area.",
        isPro: true,
        registryName: "dashboard-page-layout1",
        height: 700
      },
      {
        href: "/blocks/page-layouts/2",
        title: "Page Layout 2",
        description: "Page layout with sidebar, top bar, and content.",
        isPro: true,
        registryName: "dashboard-page-layout2",
        height: 400
      },
      {
        href: "/blocks/page-layouts/3",
        title: "Page Layout 3",
        description: "Full page structure with nav and content region.",
        isPro: true,
        registryName: "dashboard-page-layout3",
        height: 400
      }
    ]
  },
    ...
    components: [
      {
        ...
        title: "Sidebar Layout 1",
        description: "Layout with collapsible sidebar and main content area.",
        isPro: true,
