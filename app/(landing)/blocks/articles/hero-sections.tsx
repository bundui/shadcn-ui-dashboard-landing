export function HeroSections() {
  return (
    <>
      ...
      <p>
        They are built for landing pages, SaaS homepages, product launches, and
        marketing sites where the first screen must capture attention and guide
        users toward a sign-up, trial, or purchase. You can use a single hero
        per page or combine variants across different routes. Because they rely
        on shadcn/ui and Tailwind, they fit into existing design systems and
